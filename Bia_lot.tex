...
{\textbf{\huge{Nghiên cứu tốt nghiệp 2}}}\\[1cm]
{\textbf{\Large{Thiết kế xây dựng web nhắn tin, gọi điện}}\\[1cm]

{\textbf{\large{LĂNG TRỌNG TIẾN}}}\\
{\large{tien.lt225933@sis.hust.edu.vn}}\\[0.5cm]
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{ll}
\multicolumn{1}{c}{\textbf{Giảng viên hướng dẫn:}} &  TS. Ngô Văn Linh \hspace{0.5cm} \underline{\hspace{3cm}}  \\[0.5cm]
