...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Hinhve/video_hls_architecture.png}
...
\begin{itemize}
    ...
    \item Tự động \texttt{join} socket vào các \texttt{Room} riêng tư (ví dụ: \texttt{room:user\_id}) để nhận thông báo cá nhân.
\end{itemize}
